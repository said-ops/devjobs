...
function JobCard() {
  return (
    // job card
    <div className="flex flex-col justify-center gap-6 p-4 rounded-md transform transition-all ease-in-out  font-kumbh bg-white w-80 h-56">
        {/* logo */}
      ...
      <div className="mt-4 flex flex-col gap-2">
        ...
        {/* job title */}
        <h2 className="text-veryDarkBlue text-[20px] font-bold">Senior Software Engineer</h2>
        {/* company name */}
