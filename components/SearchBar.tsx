    ...
    >
      ...
      <fieldset className="flex-1  flex items-center justify-between px-4  gap-2">
        <div className="flex items-center gap-1">
          <input type="checkbox" name="contract" id="contract" className=" w-4 h-4 lg:w-6 lg:h-6" />
          <label htmlFor="contract" className="font-kumbh md:font-semibold">
          Full time only
          </label>
        </div>
        <Button text="Search" bg="bg-violet" bgHover="hover:bg-lightViolet" w="w-32" h="h-12" />
      </fieldset>
    </form>
  );
}
